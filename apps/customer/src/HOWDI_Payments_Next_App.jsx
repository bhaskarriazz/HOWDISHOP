...
function App() {
  ...
  const addPaymentMethod = () => {
    ...
    const method = {
      ...
      type: paymentType,
      value,
      label: paymentType === "UPI" ? "UPI ID" : paymentType === "CARD" ? "Card" : "Bank Account",
    };
                  ...
                  <div style={{ minHeight: "420px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "18px", marginBottom: "24px" }}>
                      <div>
                        ...
                        <p style={{ color: "#64748b", margin: 0 }}>Save a payment method for faster and easier checkout.</p>
                      </div>
                      <button
                        type="button"
                        onClick={() => setPaymentFormOpen((open) => !open)}
                        style={{ border: 0, borderRadius: "12px", padding: "12px 16px", background: "#365947", color: "#fff", fontWeight: 800, cursor: "pointer", whiteSpace: "nowrap" }}
                      >
                        + Add payment
                      </button>
                    </div>
                    ...
                    {paymentFormOpen && (
                      <div style={{ padding: "18px", border: "1px solid #e2e8f0", borderRadius: "16px", background: "#f8fafc", marginBottom: "18px" }}>
                        <div style={{ display: "grid", gridTemplateColumns: "150px 1fr auto", gap: "10px", alignItems: "end" }}>
                          <label style={{ fontSize: "12px", fontWeight: 800, color: "#475569" }}>
                            <span style={{ display: "block", marginBottom: "7px" }}>TYPE</span>
                            <select value={paymentType} onChange={(e) => setPaymentType(e.target.value)} style={{ width: "100%", height: "44px", border: "1px solid #cbd5e1", borderRadius: "10px", padding: "0 10px", background: "#fff" }}>
                          ...
                          <label style={{ fontSize: "12px", fontWeight: 800, color: "#475569" }}>
                            <span style={{ display: "block", marginBottom: "7px" }}>{paymentType === "UPI" ? "UPI ID" : paymentType === "CARD" ? "CARD DETAILS" : "ACCOUNT DETAILS"}</span>
                            <input value={paymentValue} onChange={(e) => setPaymentValue(e.target.value)} placeholder={paymentType === "UPI" ? "name@upi" : paymentType === "CARD" ? "Visa •••• 1234" : "Bank account"} style={{ width: "100%", height: "44px", boxSizing: "border-box", border: "1px solid #cbd5e1", borderRadius: "10px", padding: "0 12px", background: "#fff" }} />
                          </label>
                          <button type="button" onClick={addPaymentMethod} style={{ height: "44px", border: 0, borderRadius: "10px", padding: "0 18px", background: "#0f172a", color: "#fff", fontWeight: 800, cursor: "pointer" }}>Save</button>
                        </div>
                      </div>
                    )}
                    ...
                    {paymentMethods.length === 0 ? (
                      <div style={{ minHeight: "250px", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", border: "1px dashed #cbd5e1", borderRadius: "18px", background: "#f8fafc" }}>
                        <div>
                          ...
                          <p style={{ color: "#64748b", margin: 0 }}>Add UPI, card or bank details to use them faster at checkout.</p>
                        </div>
                      </div>
                    ) : (
                ...
                {[
                  ...
                  <div style={{ minHeight: "420px", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
                    <div>
                      ...
                      <h3 style={{ fontSize: "24px", margin: "14px 0 8px" }}>
                        {{
                          wallet: "HOWDI Wallet",
                          cashback: "Cashback",
                          rewards: "Rewards",
                      ...
                      <p style={{ color: "#64748b", maxWidth: "440px" }}>
                        This HOWDI module is ready for the next integration.
                      </p>
                    </div>
                  </div>
                )}
