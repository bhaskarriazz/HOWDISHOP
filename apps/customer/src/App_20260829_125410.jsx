...
return () => window.clearInterval(timer);
  ...
  return (
    ...
    {/* HOWDI cancellation transparency */}
  ...
  <section style={{
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,flexWrap:"wrap"}}>
      <div>
        ...
        <h3 style={{margin:"5px 0 0",fontSize:22}}>Cancellation history</h3>
        <p style={{margin:"6px 0 0",color:"#64748b",fontSize:13}}>
          See who cancelled the order, why it happened, when it happened and what happens to your refund.
        </p>
      </div>
    </div>
    ...
    <div style={{display:"grid",gap:14,marginTop:16}}>
      {orders.filter((order) => ["cancelled", "canceled"].includes(String(order.status || "").toLowerCase())).map((order) => {
        const c = order.cancellation;
        return (
          <article key={`cancel-${order.id}`} style={{
            padding:"16px",
            borderRadius:15,
            background:"#fff",
            border:"1px solid #eadfd5"
            ...
            <div style={{display:"flex",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}>
              <div>
                ...
                <div style={{fontSize:12,color:"#64748b",marginTop:4}}>
                  Cancelled {c?.date ? new Date(c.date).toLocaleString() : "—"}
                </div>
              </div>
              <span style={{
                padding:"6px 10px",borderRadius:999,background:"#fff1f2",
                color:"#be123c",fontSize:11,fontWeight:900
              }}>CANCELLED</span>
            </div>
            ...
            <div style={{
              ...
              <div><small style={{color:"#94a3b8"}}>Cancelled by</small><div style={{fontWeight:800}}>{c?.actor || "—"}</div></div>
              <div><small style={{color:"#94a3b8"}}>Reason</small><div style={{fontWeight:800}}>{c?.reason || "—"}</div></div>
              <div><small style={{color:"#94a3b8"}}>Refund</small><div style={{fontWeight:800}}>{c?.refundStatus || "—"}</div></div>
            </div>
            ...
            <div style={{marginTop:12,padding:12,borderRadius:12,background:"#f8fafc"}}>
              ...
              <div style={{marginTop:5,fontSize:13,lineHeight:1.5}}>{getCancellationDescription(order)}</div>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:8,marginTop:8}}>
                {(order.timeline || []).map((step, i) => (
                  <span key={i} style={{
                    ...
                    background: step.label === "Cancelled" ? "#fff1f2" : "#f1f5f9",
                    color: step.label === "Cancelled" ? "#be123c" : "#475569",
    ...
    >
      <div style={{display:"flex",justifyContent:"space-between",gap:12}}>
        <div>
          ...
          <h2 style={{margin:"5px 0"}}>Why are you cancelling?</h2>
        ...
        <button type="button" onClick={() => setShowCancellationModal(false)} style={{
          width:36,height:36,border:0,borderRadius:10,background:"#f1f5f9",cursor:"pointer",fontSize:18
        }}>×</button>
      </div>
      ...
      <div style={{marginTop:16}}>
        ...
        <select value={cancellationReason} onChange={(e) => setCancellationReason(e.target.value)} style={{
          width:"100%",padding:"12px",borderRadius:11,border:"1px solid #cbd5e1",background:"#fff"
        }}>
      ...
      <div style={{marginTop:16}}>
        ...
        <textarea value={cancellationDetails} onChange={(e) => setCancellationDetails(e.target.value)}
          ...
          style={{width:"100%",boxSizing:"border-box",padding:"12px",borderRadius:11,border:"1px solid #cbd5e1",resize:"vertical"}}
        />
      </div>
      ...
      <div style={{display:"flex",gap:10,marginTop:18}}>
        <button type="button" onClick={() => setShowCancellationModal(false)} style={{
          flex:1,minHeight:46,border:"1px solid #cbd5e1",borderRadius:11,background:"#fff",fontWeight:900,cursor:"pointer"
        }}>Keep Order</button>
